...
// import { forDetailPopular} from "@/sanity/lib/queries";
...
// const QueryDetailPopular: React.FC = () => {
//   const [products, setProducts] = useState<Product[]>([]);

//   const fetchProducts = async () => {
//     try {
//       const data = await sanity.fetch(forDetailPopular);
//       setProducts(data);
//     } catch (error) {
...
// export default QueryDetailPopular;
